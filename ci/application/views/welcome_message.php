...
<script>
    let refresh = () =>{
        $.ajax({
            method: 'post',
            dataType: 'json',
			url: 'https://<?php echo $_SERVER['HTTP_HOST']; ?>/system777/mycode/jobopp/ci/welcome/index2',
            data: {
                'action': 'refresh'
            },
    ...
    let datain = () => { //get and insert must different function
        ...
        $.ajax({
            method: 'post',
            dataType: 'json',
            url: 'https://<?php echo $_SERVER['HTTP_HOST']; ?>/system777/mycode/jobopp/ci/welcome/saverecords',
            data: {
                'action': 'datain'
            },
            success: function (jsarr) {
                
				if (jsarr == null) { //success
